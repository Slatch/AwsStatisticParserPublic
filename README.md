...
CREATE TABLE IF NOT EXISTS `usage` (`id` int(13) unsigned NOT NULL auto_increment, `key` varchar(32)  NOT NULL default '', `size` int(11) NOT NULL default '0', PRIMARY KEY  (`id`));
